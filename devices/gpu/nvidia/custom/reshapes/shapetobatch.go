...
func (o *Ops) GetS2BOutputDims(x *tensor.Volume, window, stride []int32) ([]int32, error) {
	_, _, dims, err := o.s2b.GetShapetoBatchOutputProperties(x.TD(), window[0], window[1], stride[0], stride[1])
	return dims, err
}
...
func (o *Ops) S2BForward(handle *cudnn.Handler, x, y *tensor.Volume, stride []int32) error {
	return o.s2b.ShapeToBatch4d(handle.XHandle(), x.TD(), x, y.TD(), y, stride[0], stride[1], true)
}
...
func (o *Ops) S2BBackward(handle *cudnn.Handler, x, y *tensor.Volume, stride []int32) error {
	return o.s2b.ShapeToBatch4d(handle.XHandle(), x.TD(), x, y.TD(), y, stride[0], stride[1], false)
}
...
func (o *Ops) B2SForward(handle *cudnn.Handler, x, y *tensor.Volume, stride []int32) error {
	return o.s2b.ShapeToBatch4d(handle.XHandle(), y.TD(), y, x.TD(), x, stride[0], stride[1], false)
}
...
func (o *Ops) B2SBackward(handle *cudnn.Handler, x, y *tensor.Volume, stride []int32) error {
	return o.s2b.ShapeToBatch4d(handle.XHandle(), y.TD(), y, x.TD(), x, stride[0], stride[1], true)
}
