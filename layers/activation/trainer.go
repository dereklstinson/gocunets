...
func (l *Layer) UpdateWeights(handle *cudnn.Handler, batch, epoch int) error {
	var err error
	if l.negCoefs != nil {
		err = l.negcotrain.UpdateWeights(handle, l.dnegCoefs, l.negCoefs, batch, epoch)
		if err != nil {
			return nil
		}
	}
	if l.posCoefs != nil {
		err = l.poscotrain.UpdateWeights(handle, l.dposCoefs, l.posCoefs, batch, epoch)
		if err != nil {
			return nil
		}
	}
	if l.threshold != nil {
		err = l.poscotrain.UpdateWeights(handle, l.dthreshold, l.threshold, batch, epoch)
		if err != nil {
			return nil
		}
	}
